...
def calculate_subtotal(order):
    ...
    """
    return round(sum(var01["price"] for var01 in order), 2)
...
def summarize_order(order):
    ...
    for var01 in order:
        my_sum += var01["price"]
        my_list01.append(var01["name"])
        
    return my_list01, round(my_sum*1.15, 2)
...
def main():
    ...
    for var01 in items:
        print(var01)
    print("Total for the order with tax is: " + str(subtotal))
